...
import 'package:realtime_innovations_project/modules/internet/constants/connection_status.dart';
import 'package:realtime_innovations_project/modules/internet/models/address_check_option.dart';
import 'package:realtime_innovations_project/modules/internet/models/address_check_result.dart';
import 'package:realtime_innovations_project/modules/internet/models/default.dart';
...
class CheckInternet {
  ...
  static List<AddressCheckOptions> defaultAddress() {
    ...
    for (final address in DefaultValues.reliableAddresses) {
      options.add(
        AddressCheckOptions(
          address,
        ),
  ...
  ///  return  [InternetConnectionStatus.established] otherwise
  /// [InternetConnectionStatus.failed]
  Future<InternetConnectionStatus> get connectionStatus async {
    return await hasConnection
        ? InternetConnectionStatus.established
        : InternetConnectionStatus.failed;
  }
  ...
  Duration checkInterval = DefaultValues.defaultInterval;
